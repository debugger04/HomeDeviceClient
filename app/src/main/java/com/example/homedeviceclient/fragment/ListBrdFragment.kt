 ...
 * Use the [ListBrdFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class ListBrdFragment : Fragment() {
    lateinit var sp: SharedPrefs
    var listPromo:ArrayList<Promo> = ArrayList()
    lateinit var txtKosong: TextView
    lateinit var brdView: RecyclerView
    var total: Int = 0
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.fragment_list_brd, container, false)
        sp = SharedPrefs(requireActivity())
        txtKosong = view.findViewById(R.id.div_brdKosong)
        brdView = view.findViewById(R.id.brd_view)
    ...
    fun updateList() {
        ...
        brdView.setLayoutManager(layout)
        brdView.setHasFixedSize(true)
        brdView.adapter = PromoAdapter(listPromo, promo, total, object: PromoAdapter.Listeners{
